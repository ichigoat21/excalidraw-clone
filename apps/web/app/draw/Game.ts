...
export class Game {
  ...
  initHandlers() {
    this.socket.onmessage = (event) => {
      ...
      // FIX: Guard against messages from other rooms.
      // Previously there was no roomId check at all, so in a multi-tab or
      // multi-room scenario every incoming shape would be applied regardless
      // of which room it belonged to.
